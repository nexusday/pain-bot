...
export async function manejarModoHumano(m, conn) {
  ...
  if (estaModoActivo('modoIA', m.chat) || estaModoActivo('modoHot', m.chat) || estaModoActivo('modoIlegal', m.chat) || estaModoActivo('modoSad', m.chat) || estaModoActivo('modoPsico', m.chat) || estaModoActivo('modoCustom', m.chat)) {
    return false
  }
