...
export function ensureModoDescargasDb() {
  if (!global.db.data.modoDescargas) global.db.data.modoDescargas = {}
  return global.db.data.modoDescargas
}

export function isModoDescargasEnabled(chatId) {
  return global.db.data.modoDescargas?.[chatId] === true
}
