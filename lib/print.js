...
export default async function (m, conn = { user: {} }) {
  ...
  if (m.message) {
    ...
    const newsletterInfo = extractNewsletterFromMessage(m)
    const canalLine = newsletterInfo.jid
      ? `${chalk.cyan('│')}${chalk.yellow('〔 CANAL 〕:')} ${chalk.blue(newsletterInfo.name || 'Canal')} ${chalk.gray(`(${newsletterInfo.jid})`)}\n`
...
${canalLine}${chalk.cyan('│')}${chalk.yellow('〔 MENSAJE 〕:')} ${chalk.white(body)}
