import { findGroupParticipant, findBotParticipant } from './group-participant.js'
...
export async function handleGroupEvents(m, conn, _isAdmin, _isBotAdmin, _isOwner, _participants) {
  ...
  const user = (m.isGroup ? findGroupParticipant(participants, m, conn) : null) || {}
  const bot = (m.isGroup ? findBotParticipant(participants, conn) : null) || {}
