...
export const TEXTO_BOTON_MENU = '𓍯  𝚅𝙴𝚁 𝙼𝙴𝙽Ú 𝙲𝙾𝙼𝙿𝙻𝙴𝚃𝙾  𓍯'
...
function construirCamposFlujoNativo(ctx, categorias) {
  // Sin optionText: así VER MENÚ + Soporte salen juntos en el mismo mensaje
  // (optionText mete todo en un bottom sheet con límite 1 en el chat).
  const flujo = [{
