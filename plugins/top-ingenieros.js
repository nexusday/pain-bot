let handler = async (m, { conn, args, participants, isAdmin, isBotAdmin, isOwner, isPrems, usedPrefix, command }) => {
  ...
  try {
    ...
    let texto = `🛠️ 𝗧𝗼𝗽 𝗶𝗻𝗴𝗲𝗻𝗶𝗲𝗿𝗼𝘀 𝗱𝗲𝗹 𝗴𝗿𝘂𝗽𝗼\n\n`
    ...
    console.error('Error en top ingenieros:', error)
    return conn.sendMessage(m.chat, {
      text: '[❌] Ocurrió un error al generar el top de ingenieros del grupo.',
      contextInfo: {
        ...rcanal.contextInfo
      }
    }, { quoted: m })
...
handler.help = ['#topingenieros']
handler.tags = ['fun', 'grupos']
handler.command = ['topingenieros', 'topingeniero', 'ingenieros', 'toping']
handler.group = true
