...
let handler = async (m, { conn, args, participants, isAdmin, isOwner, usedPrefix, command }) => {
  if (!m.isGroup) {
...
handler.help = ['#warn @usuario [motivo] / responder']
