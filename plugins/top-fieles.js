let handler = async (m, { conn, args, participants, isAdmin, isBotAdmin, isOwner, isPrems, usedPrefix, command }) => {
  ...
  try {
    ...
    let texto = `💞 𝗧𝗼𝗽 𝗳𝗶𝗲𝗹𝗲𝘀 𝗱𝗲𝗹 𝗴𝗿𝘂𝗽𝗼\n\n`
    ...
    console.error('Error en top fieles:', error)
    return conn.sendMessage(m.chat, {
      text: '[❌] Ocurrió un error al generar el top de fieles del grupo.',
      contextInfo: {
        ...rcanal.contextInfo
      }
    }, { quoted: m })
...
handler.help = ['#topfieles']
handler.tags = ['fun', 'grupos']
handler.command = ['topfieles', 'topfiel', 'fieles', 'fieletop']
handler.group = true
